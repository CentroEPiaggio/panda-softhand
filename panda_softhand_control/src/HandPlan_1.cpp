...
HandPlan_1::HandPlan_1(ros::NodeHandle& nh_, int n_wp_, std::string synergy_joint_name_){
        ...
        this->joints_sub = this->nh.subscribe("/joint_states", 1, &HandPlan_1::joints_callback, this);
...
HandPlan_1::~HandPlan_1(){
    // Nothing to do here yet
}

// This is the callback function of the hand plan service
bool HandPlan_1::call_hand_plan(panda_softhand_control::hand_plan::Request &req, panda_softhand_control::hand_plan::Response &res){
    ...
    if(!this->initialize()){
        ROS_ERROR("Could not initialize HandPlan_1 object. Returning...");
        res.answer = false;
        return false;
    }
...
void HandPlan_1::joints_callback(const sensor_msgs::JointState::ConstPtr &jnt_msg){
...
void HandPlan_1::computeTrajectory(double present_syn, double goal_syn, double time){
