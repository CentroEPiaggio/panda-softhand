...
bool SlerpPlan::performMotionPlan(){
    ...
    const double velocity_scaling_factor = 0.6; // Set your desired velocity scaling factor
    const double acceleration_scaling_factor = 0.3; // Set your desired acceleration scaling factor
