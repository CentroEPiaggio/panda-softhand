...
JointPlan_1::JointPlan_1(ros::NodeHandle& nh_, std::string group_name_){
        
        ROS_INFO("Starting to create JointPlan_1 object");
        ...
        ROS_INFO("Finished creating JointPlan_1 object");
}

JointPlan_1::~JointPlan_1(){
    
    // Nothing to do here yet
}

// This is the callback function of the joint plan service
bool JointPlan_1::call_joint_plan(panda_softhand_control::joint_plan::Request &req, panda_softhand_control::joint_plan::Response &res){

    // Setting up things
    if(!this->initialize(req)){
        ROS_ERROR("Could not initialize JointPlan_1 object. Returning...");
        res.answer = false;
        return false;
    }
    ...
    if(!this->performMotionPlan()){
        ROS_ERROR("Could not perform motion planning in JointPlan_1 object. Returning...");
        res.answer = false;
        return false;
    }
...
bool JointPlan_1::initialize(panda_softhand_control::joint_plan::Request &req){
...
bool JointPlan_1::performMotionPlan(){
